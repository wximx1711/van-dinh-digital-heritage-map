...
public static class MappingExtensions
{
    ...
    public static SystemSettingDto ToDto(this SystemSetting item) => new(item.SettingId, item.WebsiteName, item.LogoUrl, item.FooterText, item.ContactEmail, item.Phone, item.Address, item.FacebookUrl, item.TiktokUrl, item.YoutubeUrl, item.HomeBackgroundType, item.HomeBackgroundImageUrl, item.HomeBackgroundVideoUrl, item.HomeBackgroundVideoPosterUrl, item.UpdatedAt);
