...
public sealed record SystemSettingDto(int SettingId, string? WebsiteName, string? LogoUrl, string? FooterText, string? ContactEmail, string? Phone, string? Address, string? FacebookUrl, string? TiktokUrl, string? YoutubeUrl, string? HomeBackgroundType, string? HomeBackgroundImageUrl, string? HomeBackgroundVideoUrl, string? HomeBackgroundVideoPosterUrl, DateTime UpdatedAt);

/// <summary>Request to update system settings.</summary>
public sealed record SystemSettingRequest(string? WebsiteName, string? LogoUrl, string? FooterText, string? ContactEmail, string? Phone, string? Address, string? FacebookUrl, string? TiktokUrl, string? YoutubeUrl, string? HomeBackgroundType, string? HomeBackgroundImageUrl, string? HomeBackgroundVideoUrl, string? HomeBackgroundVideoPosterUrl);
