...
namespace VanDinh.API.Migrations
{
    ...
    [Migration("20260703000000_AddAuditFieldsToIntangibleHeritage")]
    partial class AddAuditFieldsToIntangibleHeritage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VanDinh.API.Models.AboutPage", b =>
                {
                    ...
                    b.ToTable("AboutPage", null, t =>
                        {
                            t.HasCheckConstraint("CK_AboutPage_Content_MinLength", "Content IS NULL OR LEN(TRIM(Content)) >= 100");
                        });
                });
