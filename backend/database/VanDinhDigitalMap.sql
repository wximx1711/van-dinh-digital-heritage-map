/*==========================================================
    ...
    GENERATED: 2026-07-19T15:00:48Z
...
INSERT [IntangibleHeritage] ([IntangibleId],[PublicId],[NameVi],[NameEn],[Category],[DescriptionVi],[DescriptionEn],[ImageUrl],[VideoUrl],[IsDeleted],[CreatedAt],[UpdatedAt],[CreatedBy],[UpdatedBy],[Community],[CulturalSpace],[CurrentStatus],[CustomsAndOfferings],[ExistingArtisans],[ExistingProtectionMeasures],[FestivalDuration],[FestivalLocation],[FestivalTime],[FolkGames],[FormationHistory],[GalleryImages],[HeritageValue],[HistoricalDevelopment],[Learners],[Location],[Origin],[OtherHumanResources],[OtherNames],[Practitioners],[ProposedProtectionMeasures],[RelatedDocuments],[RepresentativePersons],[RiskDescription],[RitualObjects],[RitualParticipants],[RitualProcess],[TeachingArtisans],[ThreatLevel],[TraditionalPerformances],[TransmissionMethod],[WorshipObjects],[OriginEn],[HeritageValueEn],[CurrentStatusEn],[RelatedDocumentsEn]) VALUES (4, N'ih0004', N'Vịt cỏ Vân Đình.', N'Van Dinh Grass Duck (Van Dinh Grass Duck Culinary Heritage).', N'ritual', N'Vịt cỏ Vân Đình là một di sản thuộc loại hình tri thức dân gian ẩm thực nổi tiếng, gắn liền với giống vịt cỏ bản địa được chăn thả truyền thống trên các cánh đồng chiêm tại xã Vân Đình, huyện Ứng Hòa, Hà Nội. Sự kết hợp độc đáo giữa chất lượng thịt vịt, kinh nghiệm lựa chọn kỹ lưỡng và bí quyết chế biến phong phú (như nướng, luộc, om sấu, làm chả, nấu cháo...) đã đưa Vân Đình trở thành "thủ phủ vịt cỏ" vang danh khắp cả nước và quốc tế. Di sản hiện được đại diện bởi bà Nguyễn Thị Sinh với gia đình có 3 đời theo nghề, không chỉ mang lại giá trị kinh tế cao mà còn là một nét chấm phá đặc sắc, khẳng định thương hiệu đặc sản vùng miền của bản đồ ẩm thực Thủ đô.', N'Van Dinh Grass Duck represents a renowned intangible cultural heritage of folk culinary knowledge, deeply associated with the indigenous grass duck breed traditionally raised on the low-lying rice fields of Van Dinh Commune, Ung Hoa District, Hanoi. The unique combination of high-quality duck meat, meticulous selection experience, and diverse specialized cooking techniques (including grilling, boiling, sour dracontomelon stewing, duck patties, and porridge) has turned Van Dinh into the famous "grass duck capital" nationwide and internationally. Represented by Ms. Nguyen Thi Sinh, whose family spans three generations in the trade, this heritage not only provides substantial economic value but also serves as a brilliant highlight that asserts the signature regional brand of Hanoi''s gastronomy.', N'/uploads/images/00d3f510bf3b431ab654105b89cdb512.png', NULL, 0, '2026-07-10T14:37:54.6718379', '2026-07-14T07:56:22.9277623', 2, 3, NULL, NULL, N'Hiện trạng: Không có nguy cơ mai một. Di sản đang phát triển rất mạnh mẽ với lực lượng thực hành đông đảo bao gồm 7 nghệ nhân (đều có khả năng truyền dạy), 23 người thực hành và 12 học viên đang theo học theo phương thức "cầm tay chỉ việc".
